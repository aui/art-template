/*! art-template@4.0.0-beta3 | https://github.com/aui/art-template */
module.exports =
...
var compile = function compile(source) {
    ...
    if (!source) {
        try {
            var target = options.resolveFilename(filename, options.root);
...
var include = __webpack_require__(11);
var resolveFilename = __webpack_require__(5);
 ...
 * @return  {string}
 */
var resolveFilename = function resolveFilename(filename, root, base) {
 ...
 * @return  {string}
 */
var include = function include(filename, data, base, root) {
    var compile = __webpack_require__(0);
    var resolveFilename = __webpack_require__(5);
