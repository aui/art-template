/*! art-template@4.2.0 | https://github.com/aui/art-template */
module.exports =
...
var compile = function compile(source) {
    ...
    if (!source) {
        ...
        var target = options.resolveFilename(filename, options);
 ...
 * @return {string}
 */
var htmlMinifier = function htmlMinifier(source) {
    var ignoreCustomFragments = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    ...
    if (detectNode) {
        ...
        return _htmlMinifier(source, options);
    } else {
        return source;
    }
};
